        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <PageNavigation
              ...
              nextPage={{
                href: '/protekaet',
                title: 'Стирал��ная машина протекает'
              }}
            />
            <svg
              width="330"
