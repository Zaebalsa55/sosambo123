          ...
          <div className="page-left-main-box">
              ...
              <div className="page-container13">
                <div className="vicetext">
                  ...
                  <p>
                    ...
                    Иногда помогает простой сброс: отключите СМА от сети на 10–15 секунд, затем включите заново. Это снимает случ��йные ошибки блока управления.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  Устройство блокировки люка (УБЛ) фиксирует дверцу перед стартом. Если оно изношено или сломано, дверца не закрывается плотно и стирка не начнётся. Симптом: машинка не запускается вообще, лю�� может остаться незаблокированным, часто загорается ошибка. Проверьте, плотно ли закрывается лю�� – он должен щёлкать. Если замок не срабатывает, машина «гудит», но воды не ��абирается. Осмотрите упл��тнитель и корпус замка: при деформации или поломке нужен мастер.
                </p>
              </div>
            </section>
