          ...
          <div className="page-left-main-box">
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="vicetext">
                  {' '}
                  Изноше��ные щетки двигателя. В большинстве машин двигатель имеет угольные ��ётки, которые со временем стираются. Из-за плохого ��онтакта мотор не набирает обороты и искрит. Вы заметите искр��ни�� вну��ри корпуса и ощущение, что барабан «лениво» пытается крутиться, но не раскручивается. Если вовремя не заменить щетки, двигатель может вообще перестать вращать барабан.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
