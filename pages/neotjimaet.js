...
const Page = (props) => {
  ...
  const structuredData = getProblemPageStructuredData(
    ...
    'Профессиональный ремонт стиральных машин которые не отжи��ают белье в Одессе. Ремонт двигателя, замена щеток.',
    `${baseUrl}/neotjimaet`
  )
          ...
          <div className="page-left-main-box">
            ...
            <section className="page-container11">
              ...
              <strong className="page-text14">
                <span>Стиральная машина не отжимает:</span>
                <br></br>
              </strong>
              <ul className="page-ul list">
                <li className="page-li1 list-item">
                  ...
                  <a href="#1" className="page-link1 ge">
                    Что делать, если маш��на не отжи��ает
                  </a>
                </li>
                ...
                <li className="page-li4 list-item ge">
                  ...
                  <a href="#3" className="page-link4">
                    2. Неисправен прессостат (датчик уров��я воды)
                  </a>
                </li>
                ...
                <li className="page-li6 list-item">
                  <img
                    ...
                    className="page-vector5"
                  />
                  <a href="#6" className="page-link6 ge">
                ...
                <li className="page-li6 list-item">
                  <img
                    ...
                    className="page-vector5"
                  />
                  <a href="#7" className="page-link6 ge">
                    6. Поломка таходатчика (датчика оборотов)
                  </a>
                </li>
              </ul>
              <svg
            ...
            <section id="1" className="page-firstproblem">
              <div className="page-container12 zagolovkiskorobkoy">
                <h2 className="zagolovki2">
                  Что делать, если машина не отжимает:
                </h2>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="page-container13">
                ...
                <div className="vicetext">
                  ...
                  <p>
                    <strong>2. Если фильтр в порядке, обрати��е внимание на сливной шланг.</strong><br />
                  ...
                  <p>
                    ...
                    Убедитесь, что вы не выбрали режим без отжима, например ��Полоскание без отжима» или «Деликатная стирка». В некоторых программах скорость вращения барабана снижена или отжим отключён полностью, чтобы не повредить ткани. Если это так, просто перезапустите стирку с нуж��ым режимом.
                  </p>

                  <p>
                    <strong>4. Иногда пробле��а связана с загрузкой белья.</strong><br />
                    Если вещ���� сбил��сь в комок, барабан не может сбалансироваться. Встроенный датчик дисбаланса блокирует разгон, чтобы машина не «скакала» по комнате. Перетряхните бельё в барабане, добавьте несколько мелких вещей или, наоборот, разделите большую партию на две стирки. Так бельё ра��пределится равномерно, и отжим пройдёт без проблем.
                  </p>
                  ...
                  <p>
                    <strong>6. Но если после всех проверок отжим всё равно не запускается, скорее ��сего, речь и��ёт о неисправности насоса, датчиков или управляющего модуля.</strong>
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="page-container20">
                <figure className="page-container21">
                  ...
                  <span className="page-text40">
                    <span>Прессостат</span>
                    <br></br>
                  </span>
                </figure>
                <p className="vicetext">
                  {' '}
                  Если ��атчик неправильно определяет уровень воды, блок управления не срабатывает нормально. При этом машинка может «зависать» перед отжимом – она не сливает воду полно��тью и аварийно останавливается. Признаки: после завершения стирки в баке ост��ётся вода, могут появляться ошибки уровня воды. Решается замена прессостата.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="vicetext">
                  {' '}
                  Изноше��ные щетки двигателя. В большинстве машин двигатель имеет угольные ��ётки, которые со временем стираются. Из-за плохого контакта мотор не набирает обороты и искрит. Вы заметите искр��ни�� вну��ри корпуса и ощущение, что барабан «лениво» пытается крутиться, но не раскручивается. Если вовремя не заменить щетки, двигатель может вообще перестать вращать барабан.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                <figure className="page-container27">
                  <img
                    alt="Порвавшийся ремень"
                    src="/10/image 38230551-800h.webp"
                    loading="lazy"
              ...
              <div className="page-container26">
                <figure className="page-container27">
                  <img
                    ...
                    className="page-image38230525"
                  />
                  <span className="page-text48">двигатель</span>
                </figure>
                <p className="vicetext">
                  {' '}
            ...
            <section className="page-frame1299">
              ...
              <div className="page-frame12986">
                <span className="page-text78">
                  Мифы о стиралк��х: что правда, а что — вымысел?
                </span>
