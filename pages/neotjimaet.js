            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                ...
                <div className="vicetext">
                  ...
                  <p>
                    <strong>6. Но если после всех проверок отжим всё равно не запускается, скорее всего, речь и��ёт о неисправности насоса, датчиков или управляющего модуля.</strong>
                  </p>
                </div>
              </div>
            </section>
