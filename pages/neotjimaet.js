          ...
          <div className="page-left-main-box">
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="vicetext">
                  {' '}
                  Изноше��ные щетки двигателя. В большинстве машин двигатель имеет угольные ��ётки, которые со временем стираются. Из-за плохого контакта мотор не набирает обороты и искрит. Вы заметите искр��ни�� внутри корпуса и ощущение, что барабан «лениво» пытается крутиться, но не раскручивается. Если вовремя не заменить щетки, двигатель может вообще перестать вращать барабан.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5-2" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                ...
                <p className="vicetext">
                  {' '}
                  Если датчик оборотов выдаёт неверные пок��зания, контроллер перестаёт доверять двигателю – стиральная машина может просто не давать команду на отжим. Это происходит без явных механически�� шумов, но при этом барабан либо вращается очень ��едленно, либо вообще не двигается. Решается заменой датчика.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
