          ...
          <div className="page-left-main-box">
              ...
              <div className="page-container13">
                ...
                <div className="vicetext">
                  ...
                  <p>
                    ...
                    Если машинка всё е��ё не подаёт признаков ж��зни, осмотрите сетевой фильтр и впус��ной клапан. Для фильтра ну��ен мультиметр, для клап��на — визуальный осмотр или звон мастеру. Часто эти детали меняют полностью.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  В большинстве современных машин стоит сетевой фильтр, который защищает электронику от скачков напряжения. Когд�� он выходит из строя, машинка переста��т реаги��овать на включение. Симптомы — шнур и ��озетка исправны, но техника полностью «мертва». Проверить фильтр можно мультиметром (или доверить мастеру). Иногда на корпусе фильтра ��идны следы подгорания. Если элемент неисправен, его просто меняют на новый.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Мозг ст��ральной машины — это управляющая плата. Именно она хранит программы стирки и управляет всеми процессами. Если ��на выходит из строя, техника не запускается, индикаторы не горят или ведут себя странно. Иногда помогает простой сброс: отключите питани�� на 10–20 минут и попробуйте снова. Если не помогло — скорее всего, нужна прошивк��, ремонт или замена модуля. Этим обычно занимается специалист.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
