          ...
          <div className="page-left-main-box">
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  В большинстве современных машин стоит сетевой фильтр, который защищает электронику от скачков напряжения. Когд�� он выходит из строя, машинка переста��т реаги��овать на включение. Симптомы — шнур и ��озетка исправны, но техника полностью «мертва». Проверить фильтр можно мультиметром (или доверить мастеру). Иногда на корпусе фильтра ��идны следы п��дгорания. Если элемент неисправен, его просто меняют на новый.
                </p>
              </div>
            </section>
