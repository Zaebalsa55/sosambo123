        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                <p className="vicetext page-text18">
                  ...
                  <br />
                  Обычно дверца автоматически разблокируется после снят��я на��ряжения, ��о если она осталась заблокиров��нной, подождите несколько минут или разберите систему блокировки (иногда нужно подождать пока УБЛ «остынет»).
                  <br />
            ...
            <section id="2e" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  6. Неисправность ТЭНа (нагревательного э��емента)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
