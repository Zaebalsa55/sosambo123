...
const Page = (props) => {
  ...
  const structuredData = getProblemPageStructuredData(
    ...
    'Профессион��льный ремонт стиральных машин которые зависают на программах в Одессе. Ремонт модуля управления.',
          ...
          <div className="page-left-main-box">
            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                <p className="vicetext page-text18">
                  <strong>1. Попро��уйте сбросить программу штатным способом.</strong>
                  <br />
                  Нажмите кнопку «Стоп» или «Пауза». В некоторых моделях ест�� отдельные режимы «Слив» ��ли «Отжим» — ��ыберите их и запустите на минимальных оборотах. Часто такой сброс по��огает завершить цикл и вернуть управление.
                  <br />
                  <strong>2. Если сбр��с не сработал — обесточьте машинку.</strong>
                  <br />
                  Вытащите вилку из р��зетки или отключите питание автоматом в щитке. Так в�� полностью снимете напряжение и исключите дальней��ие сбои.
                  <br />
                  <strong>3. Сделайте аварийный слив вручную(при необходимости).</strong>
                  <br />
                  Если вода не уходит при штатных попытках, подставьте под фильтр глубокую ёмкость. Открутите сливной фильтр против часовой стрелки. После откручивания вода пойдёт в ёмкость; Слейте всю жидкость и уберите ��усор из фильтра и отверстия. Такие де��ствия помогают во����становить слив во многих случаях.
                  <br />
                  <strong>4. После ручного слива можно безопасно открыть люк.</strong>
                  <br />
                  Обычно дверца автоматически разблокируется после снятия на��ряжения, ��о если она осталась заблокиров��нной, подождите несколько минут или разберите систему блокировки (иногда нужно подождать пока УБЛ «остынет»).
                  <br />
            ...
            <div className="page-container15">
              <h2 className="page-text34">
                <span>Другие возможные причины:</span>
                <br></br>
              </h2>
            </div>
              ...
              <div className="page-container17">
                <figure className="page-container18">
                  ...
                  <span className="page-text19">
                    <span>Сливной фильтр</span>
                    <br></br>
                  </span>
                </figure>
                <p className="vicetext">
                  {' '}
                  Сливной фильтр — это сетчатый элемент на передней нижней ча��ти машины, который задерживает ворсинки, мелкий мусор и мелкие предметы при сливе. Если фильтр забит, вода не ��ходит из бака, бельё остается мокрым, а насос (помпа) не может откачать жидкость. Программа может «зависнуть» на этапе слива или отжима. Проверьте, не гудит ли насос без слива или не остаётся ��и вода после цикла — это признаки засора. Проверьте фильтр. Удалите грязь и скопившийся м��сор, промойте фильтр тёплой водой и закрутите обратно. Обыч��о эту процедуру можно ��ыполнить самостоятельно (важно предварительно слить воду че��ез фильтр или аварийный слив). Если после очистки фильтра машин��а снова работает нормально, причина найдена. Ес��и фильтр чист и вода всё равно не уходит, проблема может быть глубже (насос, шланги и т.д.).
                </p>
              </div>
            </section>
            <section id="2a" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  2. Неплотно закрыт люк или неисправен замок
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <section id="2b" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  3. Проблемы с отводом в��ды (на��ос, патрубок, шланг)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="page-container17">
                <p className="vicetext">
                  {' '}
                  Насос и сливной шланг отвечают за отвод воды из машины. Проверьте ��ливной шланг: при сильном перегибе или засоре вода плохо уходит. О��ключите шланг от канализации (или от задней части машины) и осмотрите его – при засоре рукав может «раздутся», быть забит ��рязью или мелкими предметами. Расправьте шланг, прочистите или замените его новым при необходимости.
                </p>
              </div>
            </section>
            ...
            <section id="2d" className="page-thirdproblem1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  5. Проблемы с датчиком ��ровня в��ды (прессостат)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Прессостат — это датчик, который определяет, сколько воды набрано в бак. Если он выходит из строя, блок управления «не знает», наполнен ли барабан водой. В результате машина может ос��ановиться сразу после начала набора ��оды или не доливать воду вовсе. Признаки: при такой неисправности машинка может резко остановиться на этапе набора, стирки, полоскания или отжима (�� зависимости о�� программы) и не продолжить цикл.
                </p>
              </div>
            </section>
            <section id="2e" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  ТЭН — это сп��раль, которая нагревает воду в баке. Если ТЭН не работа��т, вода не достигает нужной темпе��атуры, а блок управления бесконечно пытается её нагреть. Машина зависает: она набрала воду, но не греет её, пытаясь дотянуть до заданной температуры. Признаком неисправности ТЭНа являет��я холодное стекло люка при выбранной горячей программе и возможная ошибка нагрева на дисплее.
                </p>
              </div>
            </section>
            ...
            <div className="page-container40">
              ...
              <div className="page-container42">
                ...
                <span className="page-text69">
                  Ка�� уд  лить пятна крови с одежды без следов?
                </span>
              </div>
              <div className="page-container43">
                ...
                <span className="page-text70">
                  Как самостояте��ьно удалить жвачку с одежды?
                </span>
              </div>
            ...
            <section className="page-frame1299">
              ...
              <div className="page-frame12981">
                <span className="page-text73">
                  Ошибки, которые приводят к дорогос��оя��ему ремонту (и как их
                  избежать)
                </span>
              ...
              <div className="page-frame12983">
                <span className="page-text75">
                  Почему стиралка воняет — 7 быстры�� причин и что сделать прямо
                  сейчас
                </span>
              ...
              <div className="page-frame12984">
                <span className="page-text76">
                  ��ак с��кономить электричест��о и воду — реальные настройки и
                  ��айфхаки
                </span>
              ...
              <div className="page-frame12985">
                <span className="page-text77">
                  Как безопасно п��ревозить и хранить стиральную машину
                </span>
