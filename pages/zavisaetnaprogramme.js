          ...
          <div className="page-left-main-box">
            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container13">
                <p className="vicetext page-text18">
                  ...
                  <br />
                  Вытащите вилку из р��зетки или отключите питание автоматом в ��итке. Так в�� полностью снимете напряжение и исключите дальней��ие сбои.
                  <br />
            ...
            <section id="2e" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  ТЭН — это сп��раль, которая нагревает воду в баке. Если ТЭН не работа��т, вода не достигает н��жной темпе��атуры, а блок управления бесконечно пытается её нагреть. Машина зависает: она набрала воду, но не греет её, пытаясь дотянуть до заданной температуры. Признаком неисправности ТЭНа являет��я холодное стекло люка при выбранной горячей программе и возможная ошибка нагрева на дисплее.
                </p>
              </div>
            </section>
