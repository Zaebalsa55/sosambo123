...
to {transform: translateX(-2620px);}}
        ...
        <div className="frame1196-container225">
          ...
          <p className="textITOGI">
            <span
              dangerouslySetInnerHTML={{
                __html: 'Ниже на сайте — карта про��зда к нашей мастер��к��й, а также наши телефоны. Звоните для записи, консультации или если з��метили сбои в работе ��ашей стиральной ��ашины. Мы всё объясним, рассчитаем стоимость и поможем."Ваше название" — это ремонт стиральных машин �� Одессе быстро, надёжно и профессио���ально.',
              }}
            ></span>
          </p>
        </div>
