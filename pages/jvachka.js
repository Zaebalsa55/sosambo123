          ...
          <div className="page-left-main-box">
            ...
            <section id="2-1" className="page-thirdproblem1-duplicate1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Этот приём подойдёт для прочных тканей (лучше избегать шёлка и шерсти). Разведите очень горячую воду и погрузите поражённый участок на 5–10 минут – жвачка быстро расплавится. Аккуратно счистите размягчённые кусочки щёткой. Также можно воспользоваться утюгом: положите под шмотку плотный картон (или бумажное полотенце), прогрейт�� утюг до 100–120°C и на несколько секунд прижмите им место с жвачкой. Жвачка расплавится и прилипнет к картону. Повто��яйте, пока все остатки не исчезнут. После используйте ткань: поместите тряпочку между утюгом и вещью, чтобы не пропекать волокна.
                </p>
              </div>
            </section>
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Другое народное средство – растительное масло или сливочное масло: нанесите его на жвачку, дождитесь 10–15 минут и попробуйте стереть жвачку (масло уменьшит её липкость). Ацетон из жидкостей для снятия лака часто заменяют уксусом: подогрейте столовый уксус до 40°C, нанесите на жвачку и оставьте на пару минут. Жвачка размягчится, и её можно будет счистить щёткой. Эти способы хор��ши, но оставляют жирные пятна: после удаления резинки одежду нужно выстирать с порошком или жидкостью для посуды.
            ...
            <section className="page-frame1299">
              ...
              <div className="page-frame12985">
                <span className="page-text77">
                  Как безопасно пе��евозить и хранить стиральную машину
                </span>
