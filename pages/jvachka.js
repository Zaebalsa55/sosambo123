          ...
          <div className="page-left-main-box">
            ...
            <section id="2-1" className="page-thirdproblem1-duplicate1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Этот приём подойдёт для прочных тканей (лучше избегать шёлка и шерсти). Разведите очень горячую воду и погрузите поражённый участок на 5–10 минут – жвачка быстро расплавится. Аккуратно счистите размягчённые кусочки щёткой. Также можно воспользоваться утюгом: положите под шмотку плотный картон (или бумажное полотенце), прогрейт�� утюг до 100–120°C и на несколько секунд приж��ите им место с жвачкой. Жвачка расплавится и прилипнет к картону. Повто��яйте, пока все остатки не исчезнут. После использ��йте ткань: поместите тряпочку между утюгом и вещью, чтобы не пропекать волокна.
                </p>
              </div>
            </section>
