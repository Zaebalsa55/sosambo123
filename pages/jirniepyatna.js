              ...
              <div className="page-container17">
                <figure className="page-container18">
                  ...
                  <span className="page-text19">
                    <span>1. Хозяйственное мыло и стиральный порошок</span>
                    <br></br>
                  </span>
                </figure>
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Если пятно свежее, хороший абсорбирующий «лайфхак» – присыпать его толстым слоем талька, крахмала или детской присыпки. Эти порошки втягивают жир из волокон. Оставьте присыпку на несколько часов или на ночь, затем сметите щёткой и постирайте изделие. Восстановить структуру ткани можно, прогладив участок через бумажное полотенце – тальк под утюгом вытянет остатки жира.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
