          ...
          <div className="page-left-main-box">
            ...
            <section id="2-2" className="page-thirdproblem1-duplicate2">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Жидкость для мытья посуды содерж��т компоненты, разрушающие жировые загрязнения, поэтому она подходит и для одежды. Нанесите несколько капель средства на п��тно и оставьте на 5–10 минут. Затем постирайте вещь – как правило, этого достаточно. Для очень застарелых пятен можно предварительно замочить одежду: нанесите гель на пятно, накройте пищевой плёнкой на пару часов, а потом постирайте в тёплой воде с порошком. Это сочетание агрессивного средства и дополнительного времени улучшит результат.
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              <div className="page-container19 zagolovkiskorobkoy">
                <h3 className="zagolovki2">4. Уксус или лимон</h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
                  height="20"
