          ...
          <div className="page-left-main-box">
            ...
            <section id="2-1" className="page-thirdproblem1-duplicate1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Датчик температуры (термостат) следит за нагревом воды и при перегреве отключает ТЭН. Если термостат выходит ��з строя, пит��ние на ТЭН не поступает, и вода остаётся холодной. Симптомы неисправности могут проявляться по-разному: ��н��шние пане��и машины перегреваются, цикл стирки длится аномально долго или машина выдаёт ошибку по перегреву. Выяснить ��оломку помогает прозвон��а: мультиметром проверяют сопротивление термостата в ��холодном» состоянии (оно должно быть конечн��м, а при н��греве – расти). Если оказывается, что датчик не замыкает цепь при нагреве, его меняют на аналогичный.Исправный термостат просто заменяют – обычно это несложная операция, и после замены машина вновь на��нёт ���реть воду нормальным образо��.
                </p>
              </div>
            </section>
            <section id="2-2" className="page-thirdproblem1-duplicate2">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  3. Неисправен датчик уровня воды (прессостат)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Прессостат (датчик уровн�� воды) сообщает моду���� управления о наполнении бака, и по сигналам датчика регулируется подача воды. Если прессостат забит или сломан, ��ашина может не начать нагревать воду – она не «увидит» необходимый уровень, чтобы включить ТЭН. Для прове��ки открывают переднюю панель и визуально осматривают трубку к прессоста��у (обычно видно под п��нелью или около насоса) на засор�� и перетяжки. Кроме того, прозванивают контакты датчика тестером. В большинстве случаев чистят внутреннюю трубку ��т грязи и мелкого мусо��а (например, нитей или монет). Если же датчик повреждён (нет реакции или неправильные показания), его заменяют новым
                </p>
              </div>
            </section>
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Часто бывает, что клеммы или провода, идущие к ТЭНу и датчикам, ослабе��ают или окисляются. Например, плохой контакт на клеммах ТЭНа приводит к тому, что элемент вообще не вклю��ается (или греется местно – проверяйте по почерневшей изоляции и оплавленным клеммам). Для диагнос����ики отключают машину от сети и мультиметром прозва��ивают всю ��епь питания ТЭНа и датчиков (исправный сигнал «должен быть», обрыв или короткое явно ук��жут на проблему). Визуально проверяют целостность проводов и коннекторов. При обнаружении плохого контакта или обрыв�� пр��водов провода меняют, а клеммы зачищают и плотно затягивают. После этого вновь проверяют нагрев – если проводка и вилка исправны, Т��Н снова н��чнёт греться.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Электронный блок управления (ЭБУ) — это «мо��г» машины. Если в нём выходят из строя силовые реле, повреждается плата или программируется ошибка, то команда на нагрев мож��т просто не подаваться. Распознать такую неисправность самостоятельно сложно: чаще всего на дисплее п��является соответствующий код, либо машина не реагирует на любые настройки. Проверку и ремонт модуля обычно доверяют ��пециалисту, однако ясно одно: при любой проблеме с платой подачу напряжения на ТЭН прекращают, и новая плата или ремонт старой полностью ре��ают проблему. Самостоятельно можно только убедиться, что напряжение в розетке подаётся и модули питания целы; для сложного ремонта платы лучше пригласить мастера.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container17">
                <p className="page-text49 vicetext">
                  {' '}
                  Иногда причиной «холодной» стирки оказывается банальная оши��ка в настройках. Если выставлен режим быстрой или энергосберегающей стирки без подогрева (или выбран ми��имальный температурный режим), машина просто не включит ТЭН. Например, регулятор температуры на панели должен соответствовать выбранной программе. Чтобы проверить, достаточно заново установить режим с высоким подогревом (40–60 °C). После корректировки настроек проблема исчез��ет – функция нагрева будет работать как положено. Такой простой совет иногда спасает до обращ��ния в сервис.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
