        ...
        <main className="page-main">
          <div className="page-left-main-box">
            ...
            <section id="2-1" className="page-thirdproblem1-duplicate1">
              <div className="page-container16 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  2. Сломан датчик температур�� (тер��остат)
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Электронный блок управления (ЭБУ) — это «мо��г» машины. Если в нём выходят из строя силовые реле, повреждается плата или программируется ош��бка, то команда на нагрев мож��т просто не подаваться. Распознать такую неисправность самостоятельно сложно: чаще всего на дисплее п��является соответствующий код, либо машина не реагирует на любые настройки. Проверку и ремонт модуля обыч��о доверяют специалисту, однако ясно одно: при любой проблеме с платой подачу напряжения на ТЭН прекращают, и новая плата или ремонт старой полностью ре��ают проблему. Самостоятельно можно только убедиться, что напряжение в розетке подаётся и модули питания целы; для сложного ремонта платы лучше пригласить мастера.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <PageNavigation
              prevPage={{
                href: '/neslivaetvodu',
                title: 'Стиральная машина н�� сливает воду'
              }}
              nextPage={{
                href: '/protekaet',
            ...
            <div className="page-container40">
              <div className="page-container41">
                ...
                <span className="page-text68">
                  Как избавить��я от жирных пятен н���� одежде в до��ашних условиях?
                </span>
              </div>
