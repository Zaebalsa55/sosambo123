...
const Page = (props) => {
  ...
  const structuredData = getProblemPageStructuredData(
    ...
    'Професси��нальный ремонт стир��льных машин которые не сливают воду в Одессе. Диагностика, чистка фильтров, ремонт насоса.',
