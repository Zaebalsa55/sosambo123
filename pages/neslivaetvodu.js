          ...
          <div className="page-left-main-box">
            ...
            <section id="1" className="page-firstproblem">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  Сливной фильтр улавливает мелк��е предметы и ворсинки, не давая им попасть в насос. Как правило, он находится в нижней части корпуса за откидной крышкой. Пе��ед нач��лом любых ��абот обязательно отключите машину от сети и подготовьте ёмкость для слива. Аккуратн�� открутите кры��ку фильтра против часов��й стрелки – под ней немедленно начнёт вытекать вода. Как только в баке останется мало воды, сработает защёлка запорного механизма, и дверца разблокируется. После этого полностью вытащите фильтр и очистите его от скопившейся пыли, волос, монеток и других посто��онних предметов. Собирая обратно, будьте осторожны: пластмассовый фильтр хрупкий. Если засор в фильтре ��ыл причиной проблемы, после его очистки вода будет свободно уходить, а люк должен открыться.
                </p>
              </div>
            </section>
            ...
            <section id="2c" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                <figure className="page-container18">
                  <img
                    alt="модуль управления ��тиральной машиной"
                    src="/1/plata.webp"
                    loading="lazy"
                    className="page-image38230522"
                  />
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  1. Если ваша ��тиральная машина подключ��на к сети, начните с отключения питания — просто выньте вилку из ро����етк��. Это обязательн��я мера безопасности, которая ис��люч��ет риск удара т��ком при любых действиях с техникой.2. За��ем подготовьте всё нео��ход��мое для слив�� воды. Возьмите несколько тряпок или старых пол��тенец — они помогут впитать пролитую воду и уберечь пол. Также стоит заранее ��риготовить невысокую ёмкость: например, плоский таз, миску или ло��ок. Если машинка установлена в ванной и есть возможность подвести шланг в душевую или ванну — это упрос��ит задачу. В остальных случая�� воду придётся собирать и переносить вру��ную — понадобится отдел����н��е в��дро или таз для слива.3. Если стирка заве��шилас�� недавно, не то��опитесь — дождитесь, пока вода остынет. Темпера��уру можно примерно оценить, при��ожив руку к стеклу люка: е��ли оно го��яче��, лучше ��емного подож���ать.4. Далее найдите сливной фи����тр — он обычно расположен ��низу пере��ней части корпуса. Закрыт он может быть небольшой пла��тиков��й крышкой. В боль��инстве моделей она снимается вручную, но если крепится на винтах — ��онадобится подх��дящая отвёртка. Учти��е, ��то фи��ьтр находится низко, почт�� у самого по��а, п��этому сливать воду нужно будет в плоскую посуду.5. Чтобы немного облегчить слив, можно аккуратно отодвинуть машинку от стены и чуть-чуть наклонит�� её ����азад — так остатки воды быстрее стекают к фильтру. Поднимать техн��ку луч��е вдвоём, так как даже ��устая машинка ��есит более 30 килограммов, а с водой и мокрым бельём — значительно больше.6. После того как вода полностью ��йд��т, можно выкрути��ь фильтр до конца и пр��верить его на нал��чие зас�����ра — нередко ��ам скапливают��я волос��, нитки, мелкие предметы. Очистите фильтр, промойте его п���� краном и установите об��атн��.
                </p>
              </div>
            </section>
            ...
            <div className="page-container40">
              <div className="page-container41">
                ...
                <span className="page-text68">
                  Как избавиться о���� жирных пятен н   одежде в домашних условиях?
                </span>
              </div>
              <div className="page-container42">
                ...
                <span className="page-text69">
                  ��а�� уд  лить пятна крови с одежды без сл��дов?
                </span>
              </div>
              <div className="page-container43">
                ...
                <span className="page-text70">
                  Как самостоятельно удалить жвачку с о��ежды?
                </span>
              </div>
              <div className="page-container44">
                ...
                <span className="page-text71">
                  Как правильно стирать пухов��к в автоматическ��й стиральной
                  машине?
                </span>
              </div>
            </div>
