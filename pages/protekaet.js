            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                <p className="page-text49 vicetext">
                  ...
                  <br />
                  <span className="tip-title">6. Не перегружайт�� барабан.</span> Переполнение бельём нарушает баланс и уве��ичивает нагрузку на уплотните��и и подшипники. Загружайте ровно столько, с��олько рекомендует производитель.
                  <br />
