          ...
          <div className="page-left-main-box">
            ...
            <section id="2" className="page-thirdproblem1">
              ...
              <div className="page-container17">
                ...
                <p className="vicetext">
                  {' '}
                  Шланги, подводящие воду к машине и отводящие её в канализацию, сильно под��ержены ��еханическим повреждениям. Например, если стиральную машину двигали или при транспортировке не убрали тр��нспортировочные кр��пления, шланг мог надорваться или ��тстегнуться. На старых машинках резиновый сливной шланг может рассохнуться и трескаться. В последнем случае воду видно под машиной ��о время слива – она капает снизу или из самого шланга.Совет: иногда проблему решает под��атягивание хомута на соединении шланга с насосом или патрубком. Если же шланг пор��ан или прогрызен (иногда кошки любят погрызть упругую резину), луч��е сразу заменить его новым – это недорогая мера, а эффект очень заметен. Аналогично проверьте шланг подачи воды: при ��ильных изгибах и перегибах он также может пропускать. Меняйте старые шланги примерно раз в пять–семь лет и при малейших признаках протечки меняйте крепления.
                </p>
              </div>
            </section>
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  В некоторых случаях вода под машиной появляется только во время отжима – это характерно для износа подшипни��ов и сальника барабана. Сальник (уплотнитель) насоса вращения постепенно истирается, из-за чего в��да попадает внутрь подшипников и ��ыходит наружу. Сначала заметно лишь учащённое включение помпы акв��стопа (если он есть), а потом ��� ржавая или с маслянистыми пятнами вода снизу. При этом маши��а громко гремит и «гуляет» на отжиме.Совет: осмотреть это своими силами можно только сняв заднюю па��ель, но замена подшипников – задача масте��а: приходится разбирать весь бак. Если вы слышите новые скрежет и вибрацию в сочета��ии с лужей под стиралкой, лучше как можно скорее вызвать специалиста. Регулярное использование специальных очис��ителей и держание машины в ровном положении может чуть замедлить износ, но окончательно ус��ранить течь сможет только замена сальника и подшипников.
                </p>
              </div>
            </section>
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Внутри машины по-прежнему течёт вода – и эт�� легко заметить по лужице под ней при заливе. К аварийным патрубкам о��носятся труба от лотка дозатора к баку и любые трубочки между баком, насосом и фильтром. Со времен��м соединения этих патрубк��в ослабевают от пос��оянной вибрации, а сами трубки могут забиваться засохшей грязью и мелкими крошками п��рошка. Засорённая или неплотно подсоединённая труба начинает пропускать в��ду на стыках, которая капает в ��оддон или сразу на пол.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container26">
                <p className="page-text49 vicetext">
                  <span className="tip-title">1. Проверяйте ка��маны и бережно укладывайте бельё.</span> Мелкие детали одежды – ��уговицы, заклёпки, монеты – кладите в стиральные мешки.
                  <br />
                  ...
                  <br />
                  <span className="tip-title">4. Держите манжету дверцы чистой.</span> Протирайте её после стирки, удаляя остатки моющих ср��дств и ворса. Осматривайте манжету на предмет трещин и сразу меняйте при необходимости.
                  <br />
            ...
            <div className="page-container40">
              ...
              <div className="page-container43">
                ...
                <span className="page-text70">
                  Ка�� самостоятельно удалить жвачку с одежды?
                </span>
              </div>
