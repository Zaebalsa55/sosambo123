...
const Page = (props) => {
  ...
  const structuredData = getProblemPageStructuredData(
    ...
    'Професси��нальный ремонт стиральных машин которые не нагревают воду в Одессе. Замена ТЭНа, ремонт термостата.',
    `${baseUrl}/negreetvodu`
  )
