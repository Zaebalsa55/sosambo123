...
const Page = (props) => {
  ...
  const structuredData = getProblemPageStructuredData(
    ...
    'Професси��нальный ремонт стиральных машин которые не нагревают во��у в Одессе. Замена ТЭНа, ремонт термостата.',
    `${baseUrl}/negreetvodu`
  )
          ...
          <div className="page-left-main-box">
            ...
            <section id="3" className="page-thirdproblem2">
              <div className="page-container19 zagolovkiskorobkoy">
                <h3 className="zagolovki2">4. Сушка пуховика</h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
                  height="20"
            ...
            <section id="4" className="page-fiveproblem1">
              <div className="page-container22 zagolovkiskorobkoy">
                <h3 className="zagolovki2">
                  5. ��бой или поломка мод��ля управления
                </h3>
                <svg
                  width="330"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="page-container17">
                ...
                <p className="page-text46 vicetext">
                  {' '}
                  Электронный блок управления (ЭБУ) — это «мо��г» машины. Если в нём выходят из строя силовы�� реле, повреждается плата или программируется ошибка, то команда на нагрев мож��т просто не подаваться. Распознать такую неисправность самостоятельно сложно: чаще всего на дисплее п��является соответствующий код, либо машина не реагирует на любые настройки. Проверку и ремонт модуля обычно доверяют специалисту, однако ясно одно: п��и любой проблеме с платой подачу напряжения на ТЭН прекращают, и новая плата или ремонт старой полностью ре��ают проблему. Самостоятельно можно только убедиться, что напряжение в розетке подаётся и модули питания целы; для сложного ремонта платы лучше пригласить мастера.
                  <span
            ...
            <section id="5" className="page-fiveproblem2">
              ...
              <div className="page-container17">
                <p className="page-text49 vicetext">
                  {' '}
                  Иногда при��иной ��холодной» стирки оказывается банальная оши��ка в настройках. Если выставлен режим быстрой или энергосберегающей стирки без подогрева (или выбран ми��имал��ный температурный режим), машина просто не включит ТЭН. Например, регулятор температуры на панели должен соответствовать выбранной программе. Чтобы проверить, достаточно заново установить режим с высоким подогревом (40–60 °C). После корректир��вки настроек проблема исчезнет – функция нагрева будет р��ботать как положено. Такой простой совет иногда спасает до обращ��ния в сервис.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
            ...
            <section className="page-frame1299">
              ...
              <div className="page-frame12983">
                <span className="page-text75">
                  Почему стиралка воняет — 7 быстрых причин и что сделать пр��мо
                  сейчас
                </span>
              ...
              <div className="page-frame12984">
                <span className="page-text76">
                  Как ��экономить электричество и воду — реальные настр��йки и
                  лайфхаки
                </span>
