          ...
          <div className="page-left-main-box">
            ...
            <section id="5-2" className="page-fiveproblem2-duplicate2">
              ...
              <div className="page-container26">
                ...
                <p className="page-text49 vicetext">
                  {' '}
                  В барабан встроен подшипниковый узел – обычно два ��арикоподшипника, ��акрытые резиновым уплотнителем (сальником). При длительной эксплуатации сальник протирается, внутрь попадает вода, ��мазка вымывается и подшипники ржавеют. Это вызывает люфт барабана �� неравномерное вращение. В итоге при отжиме машина может сильно шуметь и «прыгать», а иногд�� барабан клинит. Признаки износа подшипников – топот под ��ашиной, подтеки ржавой воды и разболт����ность бака при ручном движении. Починка ����ребу��т замены подшипников (и сальника) – в б��льшинстве моделей это комплексная работа, выпол��яемая в сервисе.
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
